...
The goal of this project is to build a joke recommending application.
...
The following plot (Fig. \ref{fig:fig5}) shows there is a lot of missing data. This is evident of a userbase that has not rated a substantial amount of the content. 
...
The ratings (as shown in the (Fig. \ref{fig:fig6}) histogram) is right skewed. with the median at a rating of 2.25.
