...
algorithms <- list(
  ...
  "user-based CF" = list(name="UBCF", param=list(normalize = "Z-score",
                                                 method="Cosine",
                                                 nn=50, minRating=3)),
  "Latent factors" = list(name="ALS", param=list(normalize = "Z-score",
                                                 n_factors=20)),
  "item-based CF" = list(name="IBCF", param=list(normalize = "Z-score",method="pearson",k=50
  ))
)
```

## run algorithms, predict next n jokes
```{r}
...
```{r}
pre <- predict(rcmnd_ub, Jokes50[101:102], n = 10)
pre
```
